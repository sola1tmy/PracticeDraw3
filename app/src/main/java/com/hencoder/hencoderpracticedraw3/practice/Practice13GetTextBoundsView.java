...
public class Practice13GetTextBoundsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text1, 100, middle + getOffset(text1), paint2);
        canvas.drawText(text2, 200, middle + getOffset(text2), paint2);
        canvas.drawText(text3, 300, middle + getOffset(text3), paint2);
        canvas.drawText(text4, 400, middle + getOffset(text4), paint2);
        canvas.drawText(text5, 500, middle + getOffset(text5), paint2);
        canvas.drawText(text6, 600, middle + getOffset(text6), paint2);
    }
